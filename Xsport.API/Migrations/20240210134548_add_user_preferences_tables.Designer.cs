...
namespace Xsport.API.Migrations
{
    ...
    [Migration("20240210134548_add_user_preferences_tables")]
    partial class add_user_preferences_tables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LanguageTypeTranslation", b =>
                {
                    b.Property<long>("LanguagesLanguageId")
                        .HasColumnType("bigint");

                    b.Property<long>("TypeTranslationsTypeTranslationId")
                        .HasColumnType("bigint");

                    b.HasKey("LanguagesLanguageId", "TypeTranslationsTypeTranslationId");

                    b.HasIndex("TypeTranslationsTypeTranslationId");

                    b.ToTable("LanguageTypeTranslation");
                });
            ...
            modelBuilder.Entity("LanguageTypeTranslation", b =>
                {
                    b.HasOne("Xsport.DB.Entities.Language", null)
                        .WithMany()
                        .HasForeignKey("LanguagesLanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Xsport.DB.Entities.TypeTranslation", null)
                        .WithMany()
                        .HasForeignKey("TypeTranslationsTypeTranslationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Xsport.DB.Entities.Type", b =>
                {
                    b.HasOne("Xsport.DB.Entities.TypeTranslation", null)
                        .WithMany("Types")
                        .HasForeignKey("TypeTranslationId");
                });
